...
class TumorDetectorGUI():
    ...
    def window(self):
        ...
        st.set_page_config(page_title="Brain Tummor Detection", page_icon=":brain:")
        

        with st.container():
            
            # st.title('Computer Vision and Pattern Recognition - Project')
            # st.title('Brain Tumor Detection')
            st.markdown("<h1 style='text-align: center; color: white;'>Computer Vision and Pattern Recognition - Project</h1>", unsafe_allow_html=True)
            st.markdown("<h2 style='text-align: center; color: white;'>Brain Tumor Detection </h2>", unsafe_allow_html=True)
